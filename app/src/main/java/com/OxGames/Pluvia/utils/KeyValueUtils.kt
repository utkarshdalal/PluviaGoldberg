...
fun KeyValue.generateSteamApp(): SteamApp {
    return SteamApp(
        ...
        developer = this["common"]["extended"]["developer"].value.orEmpty(),
        publisher = this["common"]["extended"]["publisher"].value.orEmpty(),
        homepageUrl = this["common"]["extended"]["homepage"].value.orEmpty(),
