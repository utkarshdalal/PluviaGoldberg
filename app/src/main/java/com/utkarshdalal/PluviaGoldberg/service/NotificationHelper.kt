...
import com.utkarshdalal.PluviaGoldberg.MainActivity
...
class NotificationHelper(private val context: Context) {
    ...
    companion object {
        ...
        private const val CHANNEL_NAME = "PluviaGoldberg Foreground Service"
    ...
    private fun createNotificationChannel() {
        val channel = NotificationChannel(
            ...
            description = "Allows to display PluviaGoldberg foreground notifications"
            setShowBadge(false)
        }
